...
/* package manager-0.1.0.0 */
#ifndef VERSION_manager
#define VERSION_manager "0.1.0.0"
#endif /* VERSION_manager */
#ifndef MIN_VERSION_manager
#define MIN_VERSION_manager(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_manager */
...
#define CURRENT_PACKAGE_KEY "manager-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "manager-0.1.0.0-inplace"
